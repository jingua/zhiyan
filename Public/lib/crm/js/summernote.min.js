	...
	var v = function() {
		...
		w = function() {
			var b = function(a, b) {
				...
				t = function(a, b) {
					var c = function() {
							var b = "<h5>" + a.image.selectFromFiles + '</h5><input class="note-image-input" id="files" type="file" name="files" accept="image/*" /><h5>' + a.image.url + '</h5><input class="note-image-url form-control span12" type="text" />',
