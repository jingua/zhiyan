...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 
  	...
  	<span class="c-gray en">&gt;</span> 编辑客户
    <!-- 返回 -->
...
<div class="page-container">
    ...
    id="form-article-add" enctype="multipart/form-data">
      ...
      <!-- text -->
  		<div class="row cl">
  			...
  			<div class="formControls col-xs-8 col-sm-9">
  				<input type="text" class="input-text" value="<?php echo ($customer["customer_name"]); ?>" placeholder="请输入联系人" 
        ...
        <!-- text -->
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2" style="width:160px;">公司名称</label>
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_company"]); ?>" placeholder="请输入公司名" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_tel"]); ?>" placeholder="请输入手机" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_qq"]); ?>" placeholder="请输入QQ" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_wechat"]); ?>" placeholder="请输入微信" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_position"]); ?>" placeholder="请输入联系人职位" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_email"]); ?>" placeholder="请输入邮箱" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_address"]); ?>" placeholder="请输入地址" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_brand"]); ?>" placeholder="请输入品牌"
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_situation"]); ?>" placeholder="请输入沟通情况" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_service_brand"]); ?>" 
          placeholder="请输入曾服务什么品牌" id="customer_service_brand" name="customer_service_brand">
        </div>
      </div>
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($customer["customer_mark"]); ?>" placeholder="请输入备注" 
...
<script>
var page_url = {
    'save_url' : "<?php echo U('Customer/customer_mod_save');?>",
