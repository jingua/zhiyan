...
<div class="page-container">
    ...
    id="form-article-add" enctype="multipart/form-data">
      ...
      <!-- text -->
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2" style="width:160px;">重新上传合同</label>
        <div class="formControls col-xs-8 col-sm-9" style="line-height:28px;">
          <span style="cursor:pointer;" id="add">请选择重新上传合同</span>
        </div>
      </div>
...
<script>
var page_url = {
    'save_url' : "<?php echo U('Business/business_reupload_save');?>",
