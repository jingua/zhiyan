...
<div class="page-container" style="margin-top:-30px;">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-top:6px;"> 
		<span class="l">
			...
			<a href="<?php echo U('Property/contract_relist');?>" class="btn btn-danger">合同记录</a>
		</span> 
		<!-- total -->
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody id="ks_user">
			<?php if(is_array($sign["sign"])): foreach($sign["sign"] as $key=>$v): ?><tr class="text-c">
				...
				<td class="td-manage">
					<?php if(($v["sign_status"]) == "2"): ?><span class="label label-success radius">通过</span>
					</a>
					<?php else: ?>
						<span class="label label-danger radius">未通过</span><?php endif; ?>
				</td>
