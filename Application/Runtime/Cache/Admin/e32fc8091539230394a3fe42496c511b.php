...
<div class="page-container" style="margin-top:-30px;">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-top:6px;"> 
		<span class="l">
			...
			<a href="<?php echo U('Property/pay_list');?>" class="btn btn-danger radius">支出审核</a>
			...
			<?php if(is_array($pay["pay"])): foreach($pay["pay"] as $key=>$v): ?><tr class="text-c">
				...
				<td class="td-manage">
					...
					<a style="text-decoration:none" class="btn btn-danger radius"
						onClick="del(this,<?php echo ($v['pay_id']); ?>)" href="javascript:;" title="通过">
						<i class="Hui-iconfont">通过</i>
					</a>
					<!-- delete -->
					<a style="text-decoration:none" class="btn btn-danger radius"
						onClick="redel(this,<?php echo ($v['pay_id']); ?>)" href="javascript:;" title="不通过">
...
<script src="/zhiyan/tp32/Public/zhiyan/common/property.js"></script>
...
var page_url = {
    ...
    'save_redel' : "<?php echo U('Property/pay_redel');?>",
    'list_url' : "<?php echo U('Property/pay_relist');?>",
}
</script>