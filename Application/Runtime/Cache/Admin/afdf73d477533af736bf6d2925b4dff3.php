...
<div class="page-container">
    ...
    id="form-article-add" enctype="multipart/form-data">
      ...
      <!-- text -->
  		<div class="row cl">
  			...
  			<div class="formControls col-xs-8 col-sm-9">
  				<input type="text" class="input-text" value="" placeholder="请输入渠道微信号" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入渠道名称" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入粉丝数量" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入头条价格" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入次条价格" 
        ...
        <div class="formControls col-xs-8 col-sm-9">
          ...
          <span class="select-box" style="width:160px;">
            <select name="province" id="province" onchange="getcity()" class="form-control select">
                ...
                <?php if(is_array($provice)): foreach($provice as $key=>$value): ?><option value="<?php echo ($value["id"]); ?>">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入头条阅读量" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入次条阅读量" 
      ...
      <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9"> 
              <textarea name="channel_descr" id="channel_descr" style="height:280px;"></textarea>
          </div>
      </div>
...
<script src="/zhiyan/business_admin/Public/lib/ue/ueditor.config.js"></script>
<script src="/zhiyan/business_admin/Public/lib/ue/ueditor.all.min.js"></script>
...
var page_url = {
    'save_url' : "<?php echo U('Channel/channel_add_save');?>",
