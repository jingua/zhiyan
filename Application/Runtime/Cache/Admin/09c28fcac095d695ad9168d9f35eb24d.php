...
<div class="page-container" style="margin-top:-30px;">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-top:6px;"> 
		<span class="l">
			...
			<a href="<?php echo U('Property/property_list_remember');?>" class="btn btn-danger radius">收款记录</a>
		...
		<span class="r" style="line-height:30px;">
			共有数据&nbsp;&nbsp;
			<strong><?php echo ($property["total"]); ?></strong>&nbsp;&nbsp;条
		</span> 
	</div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody id="ks_user">
			...
			<tr><td colspan=15 style="text-align:center;"><?php echo ($property["link"]); ?></td></tr>
		</tbody>
	</table>
	</div>
</div>
