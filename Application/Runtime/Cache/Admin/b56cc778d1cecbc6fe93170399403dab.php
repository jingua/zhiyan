...
<div class="page-container">
    ...
    id="form-article-add" enctype="multipart/form-data">
      ...
      <!-- text -->
  		<div class="row cl">
  			...
  			<div class="formControls col-xs-8 col-sm-9">
  				<input type="text" class="input-text" value="" placeholder="请输入合同名称" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="" placeholder="请输入合同说明" 
     ...
     <!-- text -->
      ...
      <div class="row cl" onClick="cus1()">
            ...
            <div class="formControls col-xs-8 col-sm-9 s11"> 
                <input type="text" class="input-text" value="" placeholder="请选择客户名称" 
      ...
      <div class="row cl">
		...
		id="datemin" class="input-text Wdate" placeholder="请选择签约开始时间" value="" 
		style="width:280px;" name="start_time">
    --
    <input type="text" 
    onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',Date:'#F<?php echo ($dp["$D('datemin') or '%y-%M-%d'"]); ?>'})" 
    id="datemin" class="input-text Wdate" placeholder="请选择签约结束时间" value="" 
...
<script>
var page_url = {
    'save_url' : "<?php echo U('Business/sign_add_save');?>",
