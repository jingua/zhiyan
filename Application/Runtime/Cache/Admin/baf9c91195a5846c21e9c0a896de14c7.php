...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 
  	...
  	<span class="c-gray en">&gt;</span> 编辑成员
    <!-- 返回 -->
...
<div class="page-container">
    ...
    id="form-article-add" enctype="multipart/form-data">
      ...
      <!-- text -->
  		<div class="row cl">
  			...
  			<div class="formControls col-xs-8 col-sm-9">
  				<input type="text" class="input-text" value="<?php echo ($member["member_name"]); ?>" placeholder="请输入姓名" 
            ...
            <div class="formControls col-xs-8 col-sm-9"> 
                <span class="select-box">
                    <select name="member_sex" id="member_sex" class="select">
                        <option value="1" <?php if(($member["member_sex"]) == "1"): ?>selected<?php endif; ?>>男</option>
                        <option value="2" <?php if(($member["member_sex"]) == "2"): ?>selected<?php endif; ?>>女</option>
                    </select>
                </span> 
            </div>
        </div>
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($member["member_tel"]); ?>" placeholder="请输入手机号" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($member["member_wachat"]); ?>" placeholder="请输入微信号" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($member["member_email"]); ?>" placeholder="请输入邮箱" 
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="<?php echo ($member["member_user"]); ?>" placeholder="请输入账号" 
            ...
            <div class="formControls col-xs-8 col-sm-9"> 
                <span class="select-box">
                    <select name="role_id" id="role_id" class="select">
                        <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["role_id"]); ?>" 
                        <?php if(($member["role_id"]) == $v["role_id"]): ?>selected<?php endif; ?>>
                        <?php echo ($v["role_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </span> 
            </div>
        </div>
...
<script>
var page_url = {
    'save_url' : "<?php echo U('Member/member_mod_save');?>",
