...
class Wechat
{
	...
	private $appid='wx06d63d99c9d45c2e';
	private $appsecret='899eb90d628ae55a4dca3b2524784606';
	...
	public $logcallback;
        //高级功能-》开发者模式-》获取
    private $app_id = 'wx06d63d99c9d45c2e';
    private $app_secret = '899eb90d628ae55a4dca3b2524784606';
	...
	public function getWebAccessToken(){
		...
		$code = $_GET['code'];
        $tokenUrl = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx06d63d99c9d45c2e&secret=899eb90d628ae55a4dca3b2524784606&code=".$code."&grant_type=authorization_code";
        $webAccessToken = $this->https_request($tokenUrl);
		$tokenUrlArr = json_decode($webAccessToken,true);
	/*	echo "<pre>";
		ECHO ($tokenUrlArr['openid']).'openid';
		echo "</pre>";*/
		//获取用户信息
	...
	function getWxAccessToken(){
		$url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx06d63d99c9d45c2e&secret=899eb90d628ae55a4dca3b2524784606";
    ...
    public function get_access_token()
    {
        ...
        $token_url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx06d63d99c9d45c2e&secret=899eb90d628ae55a4dca3b2524784606&code={$code}&grant_type=authorization_code";
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	public function getOauthRedirect($callback,$state='',$scope='snsapi_userinfo'){
		return self::OAUTH_PREFIX.self::OAUTH_AUTHORIZE_URL.'appid='.$this->app_id.'&redirect_uri='.urlencode($callback).'&response_type=code&scope='.$scope.'&state='.$state.'#wechat_redirect';
	}
